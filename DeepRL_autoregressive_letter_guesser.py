...
A = Actor(env, batch_size=100, epsilon=0.1, learning_rate=1e-5, actor_repetition=10, critic_repetition=2,
          random_batch=True, sample_size=15, display_progress_bar=True)
...
A.train(epochs=10000, print_freq=100, display_progress_bar=True)
